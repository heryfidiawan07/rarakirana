...
<div class="container">
  <div class="row">
      ...
      <h5 class="text-center"><b>Tuis Thread</b></h5>
    	<form method="POST" action="/user/forum/{{$thread->id}}/update">
        {{ csrf_field() }}
        ...
        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
            ...
            <input type="text" class="form-control" name="title" value="{{ $thread->title }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
            ...
            <textarea cols="10" rows="15" name="description" class="form-control">{!! $thread->description !!}</textarea>
