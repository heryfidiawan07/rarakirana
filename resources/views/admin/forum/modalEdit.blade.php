<a class="btn btn-primary btn-xs" href="#" type="button"  data-toggle="modal" data-target=".modalcategoryEdit_{{$category->id}}">
    <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
    <small> Edit</small>
    <span class="caret"></span>
</a>

<div class="modal fade modalcategoryEdit_{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form" method="POST" action="/admin/forum/category/{{$category->id}}/update">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="category" type="text" class="form-control" name="category" value="{{$category->menu}}" required autofocus>
