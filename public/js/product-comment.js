$(document).ready(function(){
  ...
  $(document).on('click','.comedit',function(){
    ...
    $(this,'.comedito').replaceWith('<br><small class="pull-right btn btn-warning btn-xs comupdate-'+comId+'" data-id="'+comId+'" data-url="/comment/'+comId+'/product/update"><span class="glyphicon glyphicon-send" aria-hidden="true"></span> update</small>');
